...
export const WORKS: Work[] = [
  {
    ...
    region: "California",
    year: 2025,
    hero: "https://images.unsplash.com/photo-1511285560929-80b456fea0bc?auto=format&fit=crop&w=2400&q=85",
    thumb: "https://images.unsplash.com/photo-1511285560929-80b456fea0bc?auto=format&fit=crop&w=1200&q=85",
    thumbAlt: "Bride and groom under a soft floral arch in golden Sonoma light.",
    aspect: "portrait",
    category: "Estate",
    narrative:
    ...
    essay: [
      ...
      {
        src: "https://images.unsplash.com/photo-1510076857177-7470076d4098?auto=format&fit=crop&w=2400&q=85",
  ...
  },
  {
    ...
    region: "Italy",
    year: 2024,
    hero: "https://images.unsplash.com/photo-1519741497674-611481863552?auto=format&fit=crop&w=2400&q=85",
    thumb: "https://images.unsplash.com/photo-1519741497674-611481863552?auto=format&fit=crop&w=1600&q=85",
    thumbAlt: "Tablescape with candles and ivory roses on a long oak table in Florence.",
    aspect: "landscape",
  ...
  },
  {
    ...
    region: "Australia",
    year: 2025,
    hero: "https://images.unsplash.com/photo-1606216794074-735e91aa2c92?auto=format&fit=crop&w=2400&q=85",
    thumb: "https://images.unsplash.com/photo-1606216794074-735e91aa2c92?auto=format&fit=crop&w=1600&q=85",
    thumbAlt: "Reception under string lights overlooking Byron Bay's headland.",
    aspect: "landscape",
    category: "Destination",
    narrative:
    ...
    essay: [
      {
        src: "https://images.unsplash.com/photo-1465495976277-4387d4b0b4c6?auto=format&fit=crop&w=2400&q=85",
  ...
  },
  {
    ...
    region: "France",
    year: 2024,
    hero: "https://images.unsplash.com/photo-1469371670807-013ccf25f16a?auto=format&fit=crop&w=2400&q=85",
    thumb: "https://images.unsplash.com/photo-1469371670807-013ccf25f16a?auto=format&fit=crop&w=1200&q=85",
    thumbAlt: "Ceremony aisle covered in white petals at a Provence chateau.",
    aspect: "portrait",
    category: "Destination",
    narrative:
  ...
  },
  {
    ...
    region: "Italy",
    year: 2025,
    hero: "https://images.unsplash.com/photo-1510076857177-7470076d4098?auto=format&fit=crop&w=2400&q=85",
    thumb: "https://images.unsplash.com/photo-1510076857177-7470076d4098?auto=format&fit=crop&w=1200&q=85",
    thumbAlt: "First dance in golden light by the shore of Lake Como.",
    aspect: "portrait",
    category: "Destination",
    narrative:
  ...
  },
  {
    ...
    region: "New York",
    year: 2025,
    hero: "https://images.unsplash.com/photo-1465495976277-4387d4b0b4c6?auto=format&fit=crop&w=2400&q=85",
    thumb: "https://images.unsplash.com/photo-1465495976277-4387d4b0b4c6?auto=format&fit=crop&w=1600&q=85",
    thumbAlt: "Bride in soft natural light at a Hudson Valley farmhouse wedding.",
    aspect: "landscape",
    category: "Intimate",
    narrative:
  ...
  },
  {
    ...
    region: "Greece",
    year: 2024,
    hero: "https://images.unsplash.com/photo-1583939003579-730e3918a45a?auto=format&fit=crop&w=2400&q=85",
    thumb: "https://images.unsplash.com/photo-1583939003579-730e3918a45a?auto=format&fit=crop&w=1200&q=85",
    thumbAlt: "Outdoor ceremony with a white archway above the Aegean.",
    aspect: "portrait",
    category: "Destination",
    narrative:
  ...
  },
  {
    ...
    region: "Italy",
    year: 2025,
    hero: "https://images.unsplash.com/photo-1606490194859-07c18c9f0968?auto=format&fit=crop&w=2400&q=85",
    thumb: "https://images.unsplash.com/photo-1606490194859-07c18c9f0968?auto=format&fit=crop&w=1600&q=85",
    thumbAlt: "Soft pink florals on a Ravello wedding table.",
    aspect: "landscape",
    category: "Destination",
    narrative:
  ...
  },
  {
    ...
    region: "Australia",
    year: 2024,
    hero: "https://images.unsplash.com/photo-1511795409834-ef04bbd61622?auto=format&fit=crop&w=2400&q=85",
    thumb: "https://images.unsplash.com/photo-1511795409834-ef04bbd61622?auto=format&fit=crop&w=1200&q=85",
    thumbAlt: "Wedding ceremony detail, hand-tied bouquet on stone.",
    aspect: "portrait",
    category: "Estate",
    narrative:
  ...
  },
  {
    ...
    hero: "https://images.unsplash.com/photo-1511285560929-80b456fea0bc?auto=format&fit=crop&w=2400&q=85",
    thumb: "https://images.unsplash.com/photo-1469371670807-013ccf25f16a?auto=format&fit=crop&w=1200&q=85",
    thumbAlt: "A small ceremony arch with white flowers in soft Kyoto light.",
    aspect: "portrait",
    category: "Intimate",
    narrative:
  ...
  },
  {
    ...
    hero: "https://images.unsplash.com/photo-1606216794074-735e91aa2c92?auto=format&fit=crop&w=2400&q=85",
    thumb: "https://images.unsplash.com/photo-1606216794074-735e91aa2c92?auto=format&fit=crop&w=1600&q=85",
    thumbAlt: "Long oak table set under a desert sky in Marfa.",
    aspect: "landscape",
    category: "Estate",
    narrative:
  ...
  },
  {
    ...
    thumbAlt: "An olive grove tablescape in golden afternoon light.",
    aspect: "portrait",
    category: "Destination",
    narrative:
